...
HD_PWD='C:/Users/Marcel/Downloads/V1_2021-03-26/V1/BlinkProject/BlinkProject.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BlinkSystem.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BlinkSystem.tcl -notrace
