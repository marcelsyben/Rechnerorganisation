...
HD_PWD='C:/Users/Marcel/Downloads/V1_2021-03-26/V1/CountProject/CountProject.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CountSystem.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CountSystem.tcl -notrace
