...
HD_PWD='C:/Users/Marcel/Desktop/V4_5/Hardware/Synthese/Synthese.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Beispielrechner_System.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Beispielrechner_System.tcl -notrace
