...
HD_PWD='C:/Users/Marcel/Desktop/V4_5/Hardware/Synthese/Synthese.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Beispielrechner_System.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Beispielrechner_System.tcl
